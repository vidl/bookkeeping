...
gulp.task('test', ['clean-build-app-dev', 'validate-server-scripts'], function () {
...
gulp.task('watch-dev', ['clean-build-app-dev', 'validate-server-scripts'], function () {
    ...
    console.log('inside watch-dev');
    // start nodemon to auto-reload the dev server
    plugins.nodemon({script: 'server.js', ext: 'js', watch: ['server.js', 'server/'], env: {STATIC_DIR: paths.distDev}})
...
gulp.task('watch-prod', ['clean-build-app-prod', 'validate-server-scripts'], function () {
    ...
    // start nodemon to auto-reload the dev server
    plugins.nodemon({script: 'server.js', ext: 'js', watch: ['server/'], env: { STATIC_DIR: paths.distProd}})
        .on('change', ['validate-server-scripts'])
        .on('restart', function () {
            console.log('[nodemon] restarted server');
        });
